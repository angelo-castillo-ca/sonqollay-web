        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid">
                    <h3 class="text-dark mb-4" style="text-align: center;">Bienvenido Administrador</h3>
                    <div style="text-align: center;">
                        <a href="alumnos.php" class="btn btn-primary">Ir a la tabla de Alumnos</a>
                    </div>
                    <div style="height: 20px;"></div>   
                    <div style="text-align: center;">
                        <a href="modulos.php" class="btn btn-primary">Ir a la tabla de Modulos</a>
                    </div>
                </div>
            </div>
        </div>
